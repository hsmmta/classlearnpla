import{m as v,k as a,c as A}from"./index-DkVAgknS.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=({name:t,iconNode:e,absoluteStrokeWidth:r,"absolute-stroke-width":o,strokeWidth:c,"stroke-width":k,size:i,color:C,...f},{slots:l})=>{const{size:n,color:m,strokeWidth:p=2,absoluteStrokeWidth:g=!1,class:x=""}=j(),b=A(()=>{const u=h(r)||h(o)||r===!0||o===!0||g===!0,d=c||k||p||s["stroke-width"];return u?Number(d)*24/Number(i??n??s.width):d});return a("svg",{...s,...f,width:i??n??s.width,height:i??n??s.height,stroke:C??m??s.stroke,"stroke-width":b.value,class:S("lucide",x,...t?[`lucide-${w(W(t))}-icon`,`lucide-${w(t)}`]:["lucide-icon"])},[...e.map(u=>a(...u)),...l.default?[l.default()]:[]])};/**
 * @license @lucide/vue v1.16.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
